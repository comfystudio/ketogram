...
var App = function() {
    ...
    var uiInit = function() {
        ...
        //Check Chosen for Subscriptions
        $('.select-chosen-sub').chosen({width: "100%", max_selected_options: 10, hide_results_on_select: false});
        $('.select-chosen-sub').on('change', function(evt, params) {
            $(".result-selected").addClass("active-result").removeClass("result-selected").delay(500);
            $(".result-selected").addClass("active-result").removeClass("result-selected").delay(500);
