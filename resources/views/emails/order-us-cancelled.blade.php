                    ...
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="400" bgcolor="white" align="center">
                                <tr>
                                    <td><h1 style = "color:#e47833; font-family: Calibri,Arial,sans-serif; text-align: center;">Order has been Cancelled</h1></td>
                                </tr>

                                <tr>
                                    <td style="padding: 10px;">
                                        <p style = "color:black; font-family: Calibri,Arial,sans-serif;">
                                            Hi us!, Someone called {{$name}}, Email: {{$email}} Has Cancelled their order
                                        </p>
                                    </td>
                                </tr>

                                <tr>
                                    <td><h3 style = "color:#e47833; font-family: Calibri,Arial,sans-serif; text-align: center;">Customer will be refunded £{{$total}} ASAP</h3></td>
                                </tr>
