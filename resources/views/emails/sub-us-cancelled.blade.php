                    ...
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="400" bgcolor="white" align="center">
                                <tr>
                                    <td><h1 style = "color:#e47833; font-family: Calibri,Arial,sans-serif; text-align: center;">Subscription has been Cancelled</h1></td>
                                </tr>

                                <tr>
                                    <td style="padding: 10px;">
                                        <p style = "color:black; font-family: Calibri,Arial,sans-serif;">
                                            Hi us!, Someone called {{$name}}, Email: {{$email}} Has Cancelled their subscription
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 10px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="200" bgcolor="#e47833" align="center">
                                            <tr>
                                                <td style = "color:white; font-weight: bold; text-align: center; padding: 10px; border-radius: 5px;"><a href="{{env('APP_URL')}}/admin/subscriptions" style="color:white; text-decoration: none;">Link To Subscriptions!</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
