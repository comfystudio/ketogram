                    ...
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="400" bgcolor="white" align="center">
                                <tr>
                                    <td><h1 style = "color:#e47833; font-family: Calibri,Arial,sans-serif; text-align: center;">Order has been Dispatched</h1></td>
                                </tr>

                                <tr>
                                    <td><h3 style = "color:#e47833; font-family: Calibri,Arial,sans-serif; text-align: center;">Your order should be with you within a few days</h3></td>
                                </tr>

                                <tr>
                                    <td style="padding: 10px;">
                                        <p style = "color:black; font-family: Calibri,Arial,sans-serif;">
                                            You can check the progress of your order via the following link <a href="https://www.royalmail.com/track-your-item#/tracking-results/{{$po_ref}}" target="_blank">Track</a>
                                        </p>
                                    </td>
                                </tr>
