                                ...
                                <div id="tabs-1-pane-1" class="active animate">
                                    <div class="tab-content">
                                        <div class="billing-form-container">
                                            <form action="/payment-create-subscribe" method="POST" id="payment-form">
                                                {{ csrf_field() }}
                                                ...
                                                <div class = "row">
                                                    <div class="column width-12 center">
                                                        <input id="checkout-pay-button" type="submit" value="Subscribe" class="form-submit button border-theme bkg-hover-theme button-blue">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
