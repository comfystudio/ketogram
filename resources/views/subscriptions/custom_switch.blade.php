            ...
            <div class="column width-12">
                <div class="title-container">
                    <div class="title-container-inner">
                        <h1 class="font-alt-1 weight-bold mb-0 color-white center">Switch to Custom Sub</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{--<div class="section-block pb-0 pt-70">--}}
            <div class="row">
                <div class="column width-10 offset-1 center">
                    <p class="lead weight-regular mb-40 text-large">Switch to Custom Sub?</p>
                    <p class="lead weight-regular mb-40">Are you sure you wish to switch to custom Subscription?</p>
                </div>
                <div class="column width-12">
                    <hr class="mb-70">
                </div>
        ...
        <div class="row">
            <div class="column width-8 offset-2 border-form">
                <div class="contact-form-container">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/subscriptions/custom').'/'.$subscriptions->id}}">
                        {{ csrf_field() }}
