    ...
    <div id="page-content">
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>@if(isset($data)) Edit @else Add @endif Food Category</h2>
            </div>
            ...
            <form action="/admin/food_categories/{{isset($categories) ? 'edit/'.$categories->id : 'create'}}" method="POST" class="form-horizontal form-bordered">
                {{ csrf_field() }}
