        	...
        	<div class="block-title">
                ...
                <div class="block-options pull-right">
    	    		 <div id="esearch" class="dataTables_filter">
    		    		<form class="form-wrap" method='get' action='/admin/food_categories/'>
    	        ...
    	        <div class="dataTables_wrapper form-inline no-footer">
    		        <div class="row">
    			       <div class="col-xs-12">
    				        <div class="pull-right">
                                <a href="/admin/food_categories/create" class="btn btn-success"><i class="fa fa-plus"></i> Add Food Category</a>
                            </div>
    					</div>
    				</div>
    				@if($categories->count())
                            ...
                            <table class="table table-bordered table-striped table-vcenter table-hover no-margin">
                                ...
                                <tbody>
                                    ...
                                    <tr @if($data->is_active == 0) class="danger" @endif >
                                        ...
                                        <td class="text-left">
                                            <a href="/admin/food_categories/edit/{{$data->id}}/" data-toggle="tooltip" title="Edit Food Category" class="btn btn-effect-ripple btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <a href="/admin/food_categories/delete/{{$data->id}}/" data-toggle="tooltip" title="Delete Food Category" class="btn btn-effect-ripple btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
    		             <div class="row no-result">
    			            <div class="col-xs-12">
    							<p>There are no Food Category to display.</p>
    			            </div>
    		            </div>
    			    @endif
