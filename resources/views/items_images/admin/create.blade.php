    ...
    <div id="page-content">
                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="header-section">
                        <ul class="breadcrumb breadcrumb-top">
                            <li><a href="/admin/items-images/{{$items->id}}/">Items Image</a></li>
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>@if(isset($data)) Edit @else Add @endif Items Image</h2>
            </div>
            ...
            <form id="form" action="/admin/items-images/{{$items->id}}/{{isset($images) ? 'edit/'.$images->id : 'create'}}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-10 double-input">
                            ...
                            <div class="col-xs-6">
                                <div class="edit-download-wrap">
                                    <a href="/admin/items-images/{{$items->id}}/download/{{$images->id}}/" class="btn btn-primary">Download Current Items Image <i class="fa fa-cloud-download"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group @if($errors->has('image')) error @endif ">
                    <label class="col-md-2 control-label" for="file">Items Image <span class="text-danger">*</span></label>
                    <div class="col-md-5">
