        	...
        	<div class="block-title">
                ...
                <div class="block-options pull-right">
    	    		 <div id="esearch" class="dataTables_filter">
    		    		<form class="form-wrap" method='get' action='/admin/recipes/'>
    	        ...
    	        <div class="dataTables_wrapper form-inline no-footer">
    		        <div class="row">
    			       <div class="col-xs-12">
    				        <div class="pull-right">
                                <a href="/admin/recipes/create" class="btn btn-success"><i class="fa fa-plus"></i> Add Recipes</a>
                            </div>
    					</div>
    				</div>
    				@if($recipes->count())
                            ...
                            <table class="table table-bordered table-striped table-vcenter table-hover no-margin">
                                ...
                                <tbody>
                                    ...
                                    <tr @if($data->is_active == 0) class="danger" @endif>
                                        ...
                                        <td class="text-left">
                                            <a href="/admin/recipes/edit/{{$data->id}}/" data-toggle="tooltip" title="Edit Recipes" class="btn btn-effect-ripple btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <a href="/admin/recipes-images/{{$data->id}}/" data-toggle="tooltip" title="Manage Images" class="btn btn-effect-ripple btn-sm btn-info"><i class="fa fa-picture-o"></i></a>
                                            <a href="/admin/recipes/delete/{{$data->id}}/" data-toggle="tooltip" title="Delete Recipes" class="btn btn-effect-ripple btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="pagination-wrap row">
                        ...
                        <div class="dataTables_paginate paging_bootstrap">
                            {{$recipes->links('partials/admin/admin')}}
                        </div>
                    </div>
    	        </div>
