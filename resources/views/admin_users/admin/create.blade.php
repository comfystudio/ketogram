    ...
    <div id="page-content">
                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="header-section">
                        <ul class="breadcrumb breadcrumb-top">
                            ...
                            <li>@if(isset($admin)) Edit @else Add @endif</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>@if(isset($admin)) Edit @else Add @endif Admin User</h2>
            </div>
            ...
            <form action="/admin/admin-users/{{isset($admin) ? 'edit/'.$admin->id : 'create'}}" method="POST" class="form-horizontal form-bordered">
                {{ csrf_field() }}
                ...
                <div class="form-group @if($errors->has('username')) error @endif">
                    ...
                    <div class="col-md-5">
                        <input type="text" id="username" name="username" class="form-control" value="@if(old('username')){{old('username')}} @elseif(isset($admin->username)){{$admin->username}}@endif">
                    </div>
                </div>
                <div class="form-group @if($errors->has('display_name')) error @endif">
                    <label class="col-md-2 control-label" for="display_name">Display Name <span class="text-danger">*</span></label>
                    <div class="col-md-5">
                        <input type="text" id="display_name" name="display_name" class="form-control" value="@if(old('display_name')){{old('display_name')}} @elseif(isset($admin->display_name)){{$admin->display_name}}@endif">
                    </div>
                </div>
                <div class="form-group @if($errors->has('email')) error @endif">
                    ...
                    <div class="col-md-5">
                        <input type="email" id="email" name="email" class="form-control" value="@if(old('email')){{old('email')}} @elseif(isset($admin->email)){{$admin->email}}@endif">
                    </div>
                </div>
                ...
                <div class="form-group form-actions">
                    <div class="col-md-5 col-md-offset-2">
                        <input type="submit" name="save" class="btn btn-effect-ripple btn-primary loader" value="@if(isset($admin)) Update @else Save @endif">
