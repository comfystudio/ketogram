            ...
            <div class="column width-8 offset-2 border-form">
                <div class="contact-form-container">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/password/reset') }}">
                        ...
                        <div class = "row">
                            <div class="column width-6 offset-6 {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                <div class="field-wrapper">
                        ...
                        <div class="row center">
                            <div class="column width-12">
                                <input type="submit" value="Reset Password" class="form-submit button border-theme bkg-hover-theme color-theme color-hover-white button-orange">
                            </div>
                        </div>
