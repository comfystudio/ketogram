    ...
    <div id="page-content">
        ...
        <div class="block">
            ...
            <div class="alert alert-danger alert-dismissable">
                ...
                <p>Please note that this will remove this User. You can add them again at a later time.</p>
            </div>
            <form action="/admin/users/delete/{{$user['id']}}" method="post" class="form-horizontal form-bordered">
                {{ csrf_field() }}
                <div class="form-group">
                    <div class="col-md-9">
                        <p class="form-control-static">You are removing: <strong>{{$user['name']}}</strong></p>
                    </div>
                </div>
